...
public class TopicViewLEFT extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.topic_view_layout_left);
		...
		// load main view
		mEdukateMainImageView = (ImageView) findViewById(R.id.imageViewTopicLeftId);
		...
		mHandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				if (msg.obj == "DONE") {
					...
					// load room view
					Intent intent = new Intent(TopicViewLEFT.this,
							QuestionView.class);
